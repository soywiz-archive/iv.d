...
/**The MIME type was not recognized, or the image data did not match the
    declared MIME type.*/
enum OP_PIC_FORMAT_UNKNOWN = -1;
/**The MIME type indicates the image data is really a URL.*/
enum OP_PIC_FORMAT_URL = 0;
/**The image is a JPEG.*/
enum OP_PIC_FORMAT_JPEG = 1;
/**The image is a PNG.*/
enum OP_PIC_FORMAT_PNG = 2;
/**The image is a GIF.*/
enum OP_PIC_FORMAT_GIF = 3;
...
/**Replace the binary suffix data at the end of the packet (if any).
   ...
   \retval #OP_EFAULT An internal memory allocation failed.*/
int opus_tags_set_binary_suffix (OpusTags* _tags, const(ubyte)* _data, int _len) /*OP_ARG_NONNULL(1)*/;
...
/**Retrieve the binary suffix data at the end of the packet (if any).
   ...
   \return A pointer to the binary suffix data, or <code>NULL</code> if none
            was present.*/
const(ubyte)* opus_tags_get_binary_suffix (const(OpusTags)* _tags, int* _len) /*OP_ARG_NONNULL(1)*/ /*OP_ARG_NONNULL(2)*/;
...
enum OP_SSL_SKIP_CERTIFICATE_CHECK_REQUEST = 6464;
enum OP_HTTP_PROXY_HOST_REQUEST = 6528;
enum OP_HTTP_PROXY_PORT_REQUEST = 6592;
enum OP_HTTP_PROXY_USER_REQUEST = 6656;
enum OP_HTTP_PROXY_PASS_REQUEST = 6720;
enum OP_GET_SERVER_INFO_REQUEST = 6784;
...
/**Skip the certificate check when connecting via TLS/SSL (https).
   ...
   \hideinitializer*/
//!#define OP_SSL_SKIP_CERTIFICATE_CHECK(_b) OP_URL_OPT(OP_SSL_SKIP_CERTIFICATE_CHECK_REQUEST), OP_CHECK_INT(_b)
...
/**Proxy connections through the given host.
   ...
   \param _host <code>const char *</code>: The proxy server hostname.
                This may be <code>NULL</code> to disable the use of a proxy
                 server.
   \hideinitializer*/
//!#define OP_HTTP_PROXY_HOST(_host) OP_URL_OPT(OP_HTTP_PROXY_HOST_REQUEST), OP_CHECK_CONST_CHAR_PTR(_host)
...
/**Use the given port when proxying connections.
   ...
   \hideinitializer*/
//!#define OP_HTTP_PROXY_PORT(_port) OP_URL_OPT(OP_HTTP_PROXY_PORT_REQUEST), OP_CHECK_INT(_port)
...
/**Use the given user name for authentication when proxying connections.
   ...
   \param _user const char *: The proxy server user name.
                              ...
                              A non-<code>NULL</code> value only has an effect
                               ...
                               arguments.
   \hideinitializer*/
//!#define OP_HTTP_PROXY_USER(_user) OP_URL_OPT(OP_HTTP_PROXY_USER_REQUEST), OP_CHECK_CONST_CHAR_PTR(_user)
...
/**Use the given password for authentication when proxying connections.
   ...
   \param _pass const char *: The proxy server password.
                              ...
                              A non-<code>NULL</code> value only has an effect
                               ...
                               arguments.
   \hideinitializer*/
//!#define OP_HTTP_PROXY_PASS(_pass) OP_URL_OPT(OP_HTTP_PROXY_PASS_REQUEST), OP_CHECK_CONST_CHAR_PTR(_pass)
...
/**Parse information about the streaming server (if any) and return it.
   ...
   \hideinitializer*/
//!#define OP_GET_SERVER_INFO(_info) OP_URL_OPT(OP_GET_SERVER_INFO_REQUEST), OP_CHECK_SERVER_INFO_PTR(_info)
...
/**Reads up to \a _nbytes bytes of data from \a _stream.
   ...
   \return The number of bytes successfully read, or a negative value on
            error.*/
alias op_read_func = int function (void* _stream, ubyte* _ptr, int _nbytes);
...
alias op_seek_func = int function (void* _stream, opus_int64 _offset, int _whence);

/**Obtains the current value of the position indicator for \a _stream.
   \return The current position indicator.*/
alias op_tell_func = opus_int64 function (void* _stream);

/**Closes the underlying stream.
   \retval 0   Success.
   \retval EOF An error occurred.
               <code>errno</code> need not be set.*/
alias op_close_func = int function (void* _stream);
...
/**Opens a stream with <code>fopen()</code> and fills in a set of callbacks
   ...
   \return A stream handle to use with the callbacks, or <code>NULL</code> on
            error.*/
void* op_fopen (OpusFileCallbacks* _cb, const(char)* _path, const(char)* _mode) /*OP_ARG_NONNULL(1)*/ /*OP_ARG_NONNULL(2)*/ /*OP_ARG_NONNULL(3)*/;
...
/**Opens a stream with <code>fdopen()</code> and fills in a set of callbacks
   ...
   \return A stream handle to use with the callbacks, or <code>NULL</code> on
            error.*/
void* op_fdopen (OpusFileCallbacks* _cb, int _fd, const(char)* _mode) /*OP_ARG_NONNULL(1)*/ /*OP_ARG_NONNULL(3)*/;
...
/**Opens a stream with <code>freopen()</code> and fills in a set of callbacks
   ...
   \return A stream handle to use with the callbacks, or <code>NULL</code> on
            error.*/
void* op_freopen (OpusFileCallbacks* _cb, const(char)* _path, const(char)* _mode, void* _stream) /*OP_ARG_NONNULL(1)*/ /*OP_ARG_NONNULL(2)*/ /*OP_ARG_NONNULL(3)*/ /*OP_ARG_NONNULL(4)*/;
...
/**Creates a stream that reads from the given URL.
   ...
   \return A stream handle to use with the callbacks, or <code>NULL</code> on
            error.*/
//!!!void* op_url_stream_vcreate (OpusFileCallbacks* _cb, const(char)* _url, va_list _ap) /*OP_ARG_NONNULL(1)*/ /*OP_ARG_NONNULL(2)*/;
...
/**Creates a stream that reads from the given URL.
   ...
   \return A stream handle to use with the callbacks, or <code>NULL</code> on
            error.*/
void* op_url_stream_create (OpusFileCallbacks* _cb, const(char)* _url, ...) /*OP_ARG_NONNULL(1)*/ /*OP_ARG_NONNULL(2)*/;
...
OggOpusFile* op_open_file (const(char)* _path, int* _error) /*OP_ARG_NONNULL(1)*/;
...
/**Open a stream from a URL.
   ...
   \param[in,out] _ap    A list of the \ref url_options "optional flags" to
                         ...
                         This is a variable-length list of options terminated
                          with <code>NULL</code>.
   \return A freshly opened \c OggOpusFile, or <code>NULL</code> on error.*/
//!!!OggOpusFile* op_vopen_url (const(char)* _url, int* _error, va_list _ap) /*OP_ARG_NONNULL(1)*/;
...
/**Open a stream from a URL.
   ...
   \param      ...    The \ref url_options "optional flags" to use.
                      This is a variable-length list of options terminated with
                       <code>NULL</code>.
   \return A freshly opened \c OggOpusFile, or <code>NULL</code> on error.*/
OggOpusFile* op_open_url (const(char)* _url, int* _error, ...) /*OP_ARG_NONNULL(1)*/;
...
OggOpusFile* op_test_file (const(char)* _path, int* _error) /*OP_ARG_NONNULL(1)*/;
...
/**Partially open a stream from a URL.
   ...
   \param[in,out] _ap     A list of the \ref url_options "optional flags" to
                          ...
                          This is a variable-length list of options terminated
                           with <code>NULL</code>.
   \return A partially opened \c OggOpusFile, or <code>NULL</code> on error.*/
//!!!OggOpusFile* op_vtest_url (const(char)* _url, int* _error, va_list _ap) /*OP_ARG_NONNULL(1)*/;
...
/**Partially open a stream from a URL.
   ...
   \param      ...     The \ref url_options "optional flags" to use.
                       This is a variable-length list of options terminated
                        with <code>NULL</code>.
   \return A partially opened \c OggOpusFile, or <code>NULL</code> on error.*/
OggOpusFile* op_test_url (const(char)* _url, int* _error, ...) /*OP_ARG_NONNULL(1)*/;
...
/**Get the serial number of the given link in a (possibly-chained) Ogg Opus
   ...
   \return The serial number of the given link.
           ...
           If the source is not seekable, this always returns the serial number
            of the current link.*/
opus_uint32 op_serialno (const(OggOpusFile)* _of, int _li=-1) /*OP_ARG_NONNULL(1)*/;
...
/**Get the channel count of the given link in a (possibly-chained) Ogg Opus
   ...
   \return The channel count of the given link.
           ...
           If the source is not seekable, this always returns the channel count
            of the current link.*/
int op_channel_count (const(OggOpusFile)* _of, int _li=-1) /*OP_ARG_NONNULL(1)*/;
...
opus_int64 op_raw_total (const(OggOpusFile)* _of, int _li=-1) /*OP_ARG_NONNULL(1)*/;
...
/**Get the total PCM length (number of samples at 48 kHz) of the stream, or of
   ...
   \retval #OP_EINVAL The source is not seekable (so we can't know the length),
                       \a _li wasn't less than the total number of links in
                       the stream, or the stream was only partially open.*/
ogg_int64_t op_pcm_total (const(OggOpusFile)* _of, int _li=-1) /*OP_ARG_NONNULL(1)*/;
...
const(OpusHead)* op_head (const(OggOpusFile)* _of, int _li=-1) /*OP_ARG_NONNULL(1)*/;
...
/**Get the comment header information for the given link in a (possibly
   ...
   \return The contents of the comment header for the given link, or
            ...
            an invalid link.*/
const(OpusTags)* op_tags (const(OggOpusFile)* _of, int _li=-1) /*OP_ARG_NONNULL(1)*/;
...
/**Computes the bitrate of the stream, or of an individual link in a
   ...
   \retval #OP_EINVAL The stream was only partially open, the stream was not
                       ...
                       links.*/
opus_int32 op_bitrate (const(OggOpusFile)* _of, int _li=-1) /*OP_ARG_NONNULL(1)*/;
...
/**Called to decode an Opus packet.
   ...
   \retval #OP_DEC_USE_DEFAULT No decoding was done.
                               <tt>libopusfile</tt> should do the decoding
                                by itself instead.*/
alias op_decode_cb_func = int function (void* _ctx, OpusMSDecoder* _decoder, void* _pcm, const(ogg_packet)* _op, int _nsamples, int _nchannels, int _format, int _li);
...
/**Reads more samples from the stream.
   ...
   \retval #OP_EBADTIMESTAMP An unseekable stream encountered a new link with
                              ...
                              checks.*/
int op_read (OggOpusFile* _of, opus_int16* _pcm, int _buf_size, int* _li) /*OP_ARG_NONNULL(1)*/;
...
/**Reads more samples from the stream.
   ...
   \retval #OP_EBADTIMESTAMP An unseekable stream encountered a new link with
                              a starting timestamp that failed basic validity
                              checks.*/
int op_read_float (OggOpusFile* _of, float* _pcm, int _buf_size, int* _li) /*OP_ARG_NONNULL(1)*/;
...
/**Reads more samples from the stream and downmixes to stereo, if necessary.
   ...
   \retval #OP_EBADTIMESTAMP An unseekable stream encountered a new link with
                              a starting timestamp that failed basic validity
                              checks.*/
int op_read_stereo (OggOpusFile* _of, opus_int16* _pcm, int _buf_size) /*OP_ARG_NONNULL(1)*/;
...
/**Reads more samples from the stream and downmixes to stereo, if necessary.
   ...
   \retval #OP_EBADTIMESTAMP An unseekable stream encountered a new link with
                              a starting timestamp that failed basic validity
                              checks.*/
int op_read_float_stereo (OggOpusFile* _of, float* _pcm, int _buf_size) /*OP_ARG_NONNULL(1)*/;
