...
alias x86_op_type = uint;
enum /*x86_op_type*/ : uint {
...
alias x86_xop_cc = uint;
enum /*x86_xop_cc*/ : uint {
...
// AVX broadcast type
alias x86_avx_bcast = uint;
enum /*x86_avx_bcast*/ : uint {
...
alias x86_sse_cc = uint;
enum /*x86_sse_cc*/ : uint {
...
alias x86_avx_cc = uint;
enum /*x86_avx_cc*/ : uint {
...
alias x86_avx_rm = uint;
enum /*x86_avx_rm*/ : uint {
...
alias x86_prefix = ubyte;
enum /*x86_prefix*/ : uint {
...
alias x86_insn_group = uint;
enum /*x86_insn_group*/ : uint {
