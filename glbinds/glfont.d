...
enum STROKE_SCALE = 1.71;
enum OUTLINE_SCALE = 0.023;
enum FILLED_SCALE = 0.023;


// ////////////////////////////////////////////////////////////////////////// //
static immutable GLint[1+MAX_STROKES*3][125] strokeFont = [
    [
  1,
  FONT_BEGIN, 0, 4,
  FONT_NEXT, 2, 2,
...
static immutable GLint[1+MAX_STROKES*3][96] outlineFont = [
    [
  32,
  FONT_ADVANCE, 250, 0
    ],
...
static immutable GLint[1+MAX_STROKES*3][96] filledFont = [
    [
  32,
  FONT_ADVANCE, 250, 0
    ],
...
static immutable GLubyte[1+13][96] bitmapFont = [
    [
  32,
...
public GLuint oglFontCreateStroke (bool downup=false) {
  ...
  for (uint i = 0; strokeFont[i][0] != END_OF_LIST; ++i) {
    glNewList(fontBase+cast(uint)strokeFont[i][0], GL_COMPILE);
    GLint mode;
...
public GLuint oglFontCreateOutline (bool downup=false) {
  ...
  for (uint i = 0; outlineFont[i][0] != END_OF_LIST; ++i) {
    glNewList(fontBase+cast(uint)outlineFont[i][0], GL_COMPILE);
    GLint mode;
...
public GLuint oglFontCreateFilled (bool downup=false) {
  ...
  for (uint i = 0; filledFont[i][0] != END_OF_LIST; ++i) {
    glNewList(fontBase+cast(uint)filledFont[i][0], GL_COMPILE);
    GLint mode;
...
// ////////////////////////////////////////////////////////////////////////// //
// returns fontBase to be passed to oglFontDrawStr
public GLuint oglFontCreateBitmap (bool downup=false) {
  GLuint fontBase = glGenLists(256);
  glPixelStorei(GL_UNPACK_ALIGNMENT, 1);
  for (uint i = 0; bitmapFont[i][0] != cast(ubyte)END_OF_LIST; ++i) {
    glNewList(fontBase+cast(uint)bitmapFont[i][0], GL_COMPILE);
...
// ////////////////////////////////////////////////////////////////////////// //
public void oglFontDrawStr(bool restorepos=true) (GLuint fontBase, GLfloat x, GLfloat y, const(char)[] str) {
  if (str.length && fontBase) {
    glPushAttrib(GL_CURRENT_BIT|GL_LIST_BIT);
    static if (restorepos) glPushMatrix();
...
// ////////////////////////////////////////////////////////////////////////// //
public void oglFontDrawStr(bool restorepos=true) (GLuint fontBase, const(char)[] str) {
  if (str.length && fontBase) {
    glPushAttrib(GL_CURRENT_BIT|GL_LIST_BIT);
    static if (restorepos) glPushMatrix();
    scope(exit) { static if (restorepos) glPopMatrix(); glPopAttrib(); }
