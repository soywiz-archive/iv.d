...
version(GNU) {
  ...
  public enum inlineMixin = `gcc.attribute.attribute("forceinline")`;
} else static if (__VERSION__ >= 2068) {
  public enum inlineMixin = `pragma(inline, true)`;
} else {
  public enum inlineMixin = ``;
}
