...
enum int X_TCP_PORT = 6000; /* add display number */
...
struct xConnSetup {
  ...
  CARD8 bitmapScanlinePad;  /* 8, 16, 32 */
...
alias xQueryFontReply = _xQueryFontReply;
...
version( X86_64 ) {
  struct xSendEventReq {
      ...
      Window destination;
      CARD32 eventMask;
      BYTE[xEvent.sizeof] eventdata;   /* the structure should have been quad-aligned */
  }
}
else {
  struct xSendEventReq {
...
alias xFillPolyReq = _FillPolyReq;
...
alias xPutImageReq = _PutImageReq;
...
enum int X_Reply    = 1;                               /* Normal reply */
enum int X_Error    = 0;                               /* Error */
